...
router.include_router(router_complementos_client.router)
router.include_router(router_combos_client.router)
router.include_router(router_busca_global_client.router)

# Rotas públicas (não requerem autenticação)
router.include_router(router_complementos_public.router)
router.include_router(router_combos_public.router)
