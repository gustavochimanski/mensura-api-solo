...
class CaixaService:
    ...
    def _caixa_to_response(self, caixa: CaixaModel) -> CaixaResponse:
        ...
        return CaixaResponse(
            ...
            valor_final=float(caixa.valor_final) if caixa.valor_final is not None else None,
            saldo_esperado=float(caixa.saldo_esperado) if caixa.saldo_esperado is not None else None,
            saldo_real=float(caixa.saldo_real) if caixa.saldo_real is not None else None,
