...
class CaixaAberturaService:
    ...
    def _abertura_to_response(self, abertura: CaixaAberturaModel) -> CaixaAberturaResponse:
        ...
        return CaixaAberturaResponse(
            ...
            valor_final=float(abertura.valor_final) if abertura.valor_final else None,
            saldo_esperado=float(abertura.saldo_esperado) if abertura.saldo_esperado else None,
            saldo_real=float(abertura.saldo_real) if abertura.saldo_real else None,
            diferenca=float(abertura.diferenca) if abertura.diferenca else None,
