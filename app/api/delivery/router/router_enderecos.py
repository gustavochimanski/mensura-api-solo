...
@router.get("/admin/cliente/{cliente_id}", response_model=List[EnderecoOut])
...
@router.post("/admin/cliente/{cliente_id}", response_model=EnderecoOut, status_code=status.HTTP_201_CREATED)
...
@router.put("/admin/cliente/{cliente_id}/endereco/{endereco_id}", response_model=EnderecoOut)
