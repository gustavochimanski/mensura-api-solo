...
from app.api.delivery.router.router_cliente_admin_dv import router as cliente_admin_router
...
from app.api.delivery.router.router_enderecos_admin_dv import router as enderecos_admin_router
from app.api.delivery.router.router_meio_pagamento import router as meio_pagamento_router
from app.api.delivery.router.router_meio_pagamento_admin_dv import router as meio_pagamento_admin_router
