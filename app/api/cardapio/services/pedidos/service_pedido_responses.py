...
from app.api.cardapio.schemas.schema_pedido_status_historico import PedidoStatusHistoricoOut
...
class PedidoResponseBuilder:
    ...
    @staticmethod
    def pedido_to_response_completo(pedido: PedidoDeliveryModel) -> PedidoResponseCompleto:
    ...
    @staticmethod
    def pedido_to_response_completo_com_endereco(pedido: PedidoDeliveryModel) -> PedidoResponseCompletoComEndereco:
    ...
    @staticmethod
    def build_endereco_selecionado(pedido: PedidoDeliveryModel) -> EnderecoOut | dict | None:
    ...
    @staticmethod
    def build_outros_enderecos(pedido: PedidoDeliveryModel) -> list[EnderecoOut | dict]:
    ...
    def build_historico_response(historico):
        """Converte histórico do modelo para o formato de resposta, extraindo username do UserModel."""
        # Se criado_por é um objeto UserModel, extrai o username
        criado_por_str = None
        if hasattr(historico, 'criado_por') and historico.criado_por:
        ...
        # Cria um dicionário com os dados do histórico, substituindo criado_por se necessário
        historico_dict = {
            'id': historico.id,
    ...
    @staticmethod
    def pedido_to_response_completo_total(pedido: PedidoDeliveryModel) -> PedidoResponseCompletoTotal:
    ...
    @staticmethod
    def pedido_to_response_simplificado(pedido: PedidoDeliveryModel) -> PedidoResponseSimplificado:
