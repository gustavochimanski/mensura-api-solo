    ...
    def buscar_vitrines_home(self, empresa_id: int) -> List[VitrineComProdutosResponse]:
        ...
        for categoria in categorias_raiz:
            ...
            for ie in produtos:
                ...
                produtos_da_vitrine.append(emp_mini)

            # 3. Só adiciona se tiver pelo menos um produto
            if produtos_da_vitrine:
                resultado.append(VitrineComProdutosResponse(
                    id=categoria.id,  # usa o id da categoria raiz
                    titulo=categoria.descricao,
                    produtos=produtos_da_vitrine[:3]  # só os 3 primeiros
                ))
