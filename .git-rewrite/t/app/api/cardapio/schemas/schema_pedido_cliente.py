...
from app.api.cardapio.schemas.schema_pedido import PedidoResponseSimplificado, TipoPedidoCheckoutEnum
...
class PedidoClienteListItem(BaseModel):
    ...
    def _validate_payload(self) -> "PedidoClienteListItem":
        ...
        if self.tipo_pedido == TipoPedidoCheckoutEnum.BALCAO and self.balcao is None:
            raise ValueError("Pedidos do tipo BALCAO precisam do payload 'balcao'.")
