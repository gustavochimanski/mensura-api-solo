...
from app.api.cardapio.router.pedidos import router_pedidos_client
...
from app.api.cardapio.router.pedidos import router_pedidos_admin
...
api_cardapio.include_router(router_pedidos_client.router)
...
api_cardapio.include_router(router_pedidos_admin.router)
