...
class ParceirosRepository:
    ...
    def create_banner(self, data: BannerParceiroIn) -> BannerParceiroModel:
        b = BannerParceiroModel(
            ...
            redireciona_categoria=data.redireciona_categoria,
            ativo=data.ativo,
    ...
    def update_banner(self, banner_id: int, data: dict) -> BannerParceiroModel:
        ...
        for key in ["nome", "imagem", "tipo_banner", "parceiro_id", "ativo", "categoria_id", "link_redirecionamento", "redireciona_categoria"]:
            if key in data:
